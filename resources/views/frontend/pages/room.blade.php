                ...
                <div class="room-item shadow rounded overflow-hidden">
                    ...
                    <div class="p-4 mt-2">
                        ...
                        <div class="d-flex mb-3">
                            <small class="border-end me-3 pe-3"><i class="fa fa-bed text-primary me-2"></i>{{ $item->bed }} Bed</small>
                            <small class="border-end me-3 pe-3"><i class="fa fa-bath text-primary me-2"></i>{{ $item->bath }} Bath</small>
                        ...
                        <div class="d-flex justify-content-between">
                            <a class="btn btn-sm btn-primary rounded py-2 px-4" href="{{ route('roomdetails', $item->id) }}">View Detail</a>
                ...
                <div class="room-item shadow rounded overflow-hidden">
                    ...
                    <div class="p-4 mt-2">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <small><i class="fa fa-wifi text-primary me-2"></i>High Speed Wifi</small>
                        </div>

                        <p class="text-body mb-3">
                            Spacious executive suite designed for business travelers with luxury comfort and premium amenities.
                        </p>
                ...
                <div class="room-item shadow rounded overflow-hidden">
                    ...
                    <div class="p-4 mt-2">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <small><i class="fa fa-wifi text-primary me-2"></i>Premium Wifi</small>
                        </div>

                        <p class="text-body mb-3">
                            Luxury presidential suite with top-class facilities, perfect for VIP guests and premium experience seekers.
                        </p>
